...
These requirements only apply if this board is built with the `hotspot-ota` mod enabled (currently the only mod, and always included by default — see root README).
