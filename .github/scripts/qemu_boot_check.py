...
def main():
    ...
    parser.add_argument("--docs-flasher-dir", type=Path, required=True)
    ...
    merge_flash_image(board, variant, args.docs_flasher_dir, flash_image)
